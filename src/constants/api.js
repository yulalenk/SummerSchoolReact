export const LOGIN_REQUEST = `https://summerschoolspring-env-1.eba-yprtczhe.eu-west-3.elasticbeanstalk.com/users/login`;
export const REGISTER_REQUEST = `https://summerschoolspring-env-1.eba-yprtczhe.eu-west-3.elasticbeanstalk.com/users/register`;
...
export const SEND_MESSAGE_CHAT_REQUEST = `http://summerschoolspring-env-1.eba-yprtczhe.eu-west-3.elasticbeanstalk.com/app/chat.sendMessage`;
